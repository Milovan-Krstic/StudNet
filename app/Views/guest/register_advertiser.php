...
<div class="content">
        <div class="sign-up-form" style="margin-top: -2.5%">
            <div class="title">Sign Up as an Advertiser</div>
                    ...
                    <div class="section">
                        <div class="row">
                            <div class="input-box col-12">
                                <div class="dropdown-select" tabindex="-1">
                                    <div class="select-btn">
                                            <span id="s2">Educational field</span>
                                            <img src="<?= base_url("icons/StudNet Caret.svg") ?>" alt="+">
                                    </div>
                        ...
                        <div class="row">
                            <div class="input-box col-12">
                                ...
                                <div class="dropdown-select" tabindex="-1">
                                    <div class="select-btn">
                                        <span id="s3">Bachelor's degree</span>
                                        <img src="<?= base_url("icons/StudNet Caret.svg") ?>" alt="+">
                                    </div>
                                    <div class="dropdown-content wide">

...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 23, 2022 at 01:57 PM
...
INSERT INTO `classes` (`idC`, `Name`, `IdSmr`) VALUES
(1, 'KDP', 1);
...
INSERT INTO `korisnik` (`IdKor`, `Ime`, `Prezime`, `Date_of_birth`, `Country`, `E-mail`, `Username`, `Password`, `Last_login`) VALUES
(14, 'EtfSelja', NULL, NULL, 'Serbia', 'EtfSelja@gmail.com', 'EtfSelja', NULL, NULL),
(15, 'EtfSeljaaas', NULL, NULL, 'Montenegro', 'EtfSelja2@gmail.com', 'EtfSelja2', NULL, NULL);
...
ALTER TABLE `chet_rooms`
  ADD CONSTRAINT `FK_IdKKa_C` FOREIGN KEY (`IdKor_KA`) REFERENCES `korisnik` (`IdKor`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdKOd_C` FOREIGN KEY (`IdKor_OD`) REFERENCES `korisnik` (`IdKor`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdPT_C` FOREIGN KEY (`IdClTag`) REFERENCES `classes` (`idC`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdP_C` FOREIGN KEY (`IdCl`) REFERENCES `classes` (`idC`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdS_C` FOREIGN KEY (`IdSm`) REFERENCES `smerovi` (`IdSmr`) ON UPDATE CASCADE;

--
-- Constraints for table `classes`
--
ALTER TABLE `classes`
  ADD CONSTRAINT `FK_IdS_Classes` FOREIGN KEY (`IdSmr`) REFERENCES `smerovi` (`IdSmr`) ON UPDATE CASCADE;
...
ALTER TABLE `frindlist`
  ADD CONSTRAINT `FK_IdKor_FL` FOREIGN KEY (`IdM`) REFERENCES `student` (`IdStud`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdKor_FL2` FOREIGN KEY (`IdF`) REFERENCES `student` (`IdStud`) ON UPDATE CASCADE;
...
--
ALTER TABLE `smerovi`
  ADD CONSTRAINT `FK_IdF_Smerovi` FOREIGN KEY (`IdFak`) REFERENCES `fakultet` (`IdF`) ON UPDATE CASCADE;
...
ALTER TABLE `zahteva_licencu`
  ADD CONSTRAINT `FK_IdS_ZL` FOREIGN KEY (`IdSer`) REFERENCES `servis` (`IdSer`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IdU_ZL` FOREIGN KEY (`IdUni`) REFERENCES `univerzitet` (`IdUni`) ON UPDATE CASCADE;
COMMIT;

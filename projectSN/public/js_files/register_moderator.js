...
$(document).ready(function() {
    ...
    $(".button input").click(function(){
        ...
        for(let i = 1; i < 6; i++) {
            ...
            if($(selector).text() == "Country" || $(selector).text() == "Faculty") {
        ...
        if(flag) {
            ...
            $(".top-message span").text("Sorry you can't sign up a Moderator...");
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response['message'] == "success") {
                            ...
                            $(".top-message span").text("You have signed up a Moderator successfully!");

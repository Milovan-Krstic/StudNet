...
<div class="content">
    <div class="sign-up-form" style="margin-top: -5%">
            <div class="title">Sign Up a Moderator</div>
                    ...
                    <div class="help-container">
                        <div class="help-c">
                            <div class="help-message">
                                <span>-Unique username must contain a letter as a first character and letters, numbers or underscores.</span><br>
                                ...
                                <br><span>-Unique e-mail must be in an e-mail form (abc@def.com).</span><br>
...
<?= script_tag('js_files/register_moderator.js') ?>